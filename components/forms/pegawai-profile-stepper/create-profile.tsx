...
export const CreateProfile: React.FC<ProfileFormType> = ({
  initialData,
  categories
}) => {
  ...
  const title = initialData ? 'Edit Data Karyawan' : 'Buat Data Karyawan Baru';
  const description = initialData
    ? 'Edit data karyawan.'
    : 'Untuk memasukkan data karyawan silahkan mengikuti langkah-langkah berikut dan wajib diisi dengan benar';
